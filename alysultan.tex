...
\begin{center}
    ...
    \small 978-325-1925 $|$ \small Reading, MA \\ \vspace{2pt}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Supervised and mentored a team of three undergraduate students in:}
          \resumeItemListStart
      ...
      %     \resumeItemListEnd
        \resumeProjectHeading
          ...
          \resumeItemListStart
            ...
            \resumeItem{Explored effects of cache hierarchy levels, sizing, replacement policy, and prefetching on hit rate} % Result of that exploration
            \resumeItem{Cache sizing and associativity was found to have the greatest impact on hit rate} % Result of that exploration
          \resumeItemListEnd
        \resumeProjectHeading
          ...
          \resumeItemListEnd
        \resumeProjectHeading
        {\textbf{Backend synthesis of a Gaussian Noise Generator} $|$ \emph{Synopsys ICC, Design compiler}}{2018}
        \resumeItemListStart
          \resumeItem{Synthesized a Gaussian noise generator using the FreePDK45 Tech node}
